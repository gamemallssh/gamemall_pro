...
<frameset cols="*,1230,*" class="bj" frameborder="no" border="0" framespacing="0">
	...
	<frameset rows="152,*" cols="*" frameborder="no" border="0">
		<!-- 导航区 -->
		<frame src="${basePath }manager_core/home_top.action" name="topFrame" scrolling="No" noresize="noresize" id="topFrame"/>
		<!-- 主区 -->
		<frameset rows="*" cols="20%,80%" frameborder="no" border="0" framespacing="0">
			<!-- 左部 -->
			<frame src="${basePath }manager_core/home_left.action" scrolling="no" noresize="noresize" id="leftFrame" />
			<!-- 右部 -->
